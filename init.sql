...
CREATE TABLE users (
    ...
    CONSTRAINT fk_training FOREIGN KEY (training_id) REFERENCES training(id) ON DELETE
    SET
        NULL
);
...
ALTER TABLE
    subjects
ADD
    CONSTRAINT fk_training_subject FOREIGN KEY (training_id) REFERENCES training(id) ON DELETE
SET
    NULL;